...
<body>
	...
	<div class="container-fluid ifp">
		<div class="w-auto bg-black text-light border wow animate__animated animate__fadeInLeft bounce-1" id="fc-ph">
			<p class="mt-3 mb-1 ms-3">Collection</p>
			<h3 class="ms-3 mb-2 me-5">Our Collection</h3>
			<a href="Home" class="ms-3 text-decoration-none" id="inf-a">Home</a> <i
				class="fa-solid fa-angles-right mb-4"></i> <a href="Products" class="text-decoration-none"
				id="inf-a">Product</a>
		</div>
...
?>
		<div class="col-12 col-sm-12 col-md-6 col-lg-4 col-xl-4 col-xxl-4">
			...
			<a href="ourcollection.php?foldername=<?php echo $subfolder;?>"><img src="img/Prieview_Product/<?php echo $subfolder.".jpg";?>" class="img-fluid img-pro" alt=""></a>
			</div>
		
			<h3 class="fw-bold p-2"><?php echo $subfolder;?></h3>
		</div>
		<?php
